...
STATE_KEYS = ['num_containers', 'avg_cpu_util', 'workload_process_rate', 'workload_change_rate']
...
class RLEnvironment:
    ...
    def __init__(self):
        ...
        self.nsfw_data = pd.read_csv('../data/nsfw_experiment3.csv')
    ...
    def get_rl_states(self) -> Dict:
        filtered_data = self.nsfw_data.query(f'num_containers == {self.num_containers} and arrival_rate == {self.workload[self.workload_indx]} and prev_arrival_rate == {self.workload[self.workload_indx-1]}')
